...
import { PassiveSkills } from './attributes/PassiveSkills';
...
const GameScene = () => {
    ...
    useEffect(() => {
        ...
        const spawnEnemy = () => {
            // Check win/gameOver state *inside* the spawn function
            ...
            for (let i = 0; i < ENEMY_SPAWN_COUNT; i++) {
                ...
                const maxX = canvasRef.current.width - (spawnZoneWidth + 0.05 * canvasRef.current.width); // Adjust multiplier if needed
